...
import hospital.vista.listeners.RedirigirAFrmConsultasMedicasPaciente;
...
public class PanelIzquierdoPaciente extends JPanel {
    ...
    private void makePanelMenu() {
        ...
        buttonConsultasMedicas = makeButtonForMenu("Consultas médicas", new RedirigirAFrmConsultasMedicasPaciente(frmMain));
