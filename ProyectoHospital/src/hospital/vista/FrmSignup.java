...
import hospital.vista.listeners.EventoButtonRegistrarPressed;
import java.awt.*;
import javax.swing.*;
...
public class FrmSignup {
    ...
    // Enlaces
    private JButton linkInciarSesion;
    ...
    private void makePanelLeft() {
        ...
        panelBrand.setLayout(new FlowLayout());
        makeLabelBrand();
        panelBrand.add(labelBrand);
        panelBrand.setBackground(new Color(38, 53, 72));

        panelLeft.add(panelBrand);

        //panelLeft.setBackground(new Color(38, 53, 72));
    }
    ...
    private void makePanelFormulario() {
        ...
        panelLinkIniciarSesion.add(linkInciarSesion);
        panelLinkIniciarSesion.setBackground(new Color(0, 0, 0, 0));

        // Agrega los JPanel al panel del formulario.
    ...
    private void makeButtonRegistrar() {
        ...
        buttonRegistrar.setFocusable(false); // No muestra ese rectángulo que se forma alrededor del texto del botón al hacer clic en el.
        buttonRegistrar.addActionListener(new EventoButtonRegistrarPressed(this));
    }

    private void makeLinkIniciarSesion() {
        linkInciarSesion = new JButton("Iniciar Sesión");
        linkInciarSesion.setBackground(new Color(255, 255, 255, 0));
        linkInciarSesion.setForeground(new Color(0, 76, 153));
        linkInciarSesion.setFocusable(false);
        linkInciarSesion.setContentAreaFilled(false);
        linkInciarSesion.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
        linkInciarSesion.setBorder(BorderFactory.createEmptyBorder());
    }
    ...
    private void makeLabelBrand() {
        ...
        labelBrand.setFont(new Font("Helvetica", Font.BOLD, 24));
