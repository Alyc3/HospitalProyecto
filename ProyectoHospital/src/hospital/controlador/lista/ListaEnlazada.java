...
public class ListaEnlazada<T> {
    ...
    /**
     * Método para obtener el último elemento de la lista Si la lista está vacía
     * retorna null
     *
     * @return
     */
    ...
    public T eliminarUltimo() {
        if (cabecera == null) { // size == 0
            ...
            T valor = cabecera.previo.valor;
            if (cabecera.siguiente == cabecera) { // size == 1
                cabecera = null;
            } else { // size >= 2
                Nodo<T> ultimo = cabecera.previo;
                ultimo.previo.siguiente = ultimo.siguiente;
                ultimo.siguiente.previo = ultimo.previo;
            }
            size--;
            return valor;
        }
    ...
    /**
     * Método para obtener el elemento en la posición pos Si la posición es
     * menor a 0 o mayor al tamanio de la lista retorna null
     *
     * @param pos
     * @return
     */
    ...
    /**
     * Método para modificar el elemento en la posición pos Si la posición es
     * menor a 0 o mayor al tamanio de la lista no ocurre nada
     *
     * @param pos
     * @param value
     */
    public void reemplazar(int pos, T value) {
        if (0 <= pos && pos < size) {
            Nodo<T> p = cabecera;
            for (int i = 1; i < pos; i++) {
                p = p.siguiente;
    ...
    public IteradorLista<T> iteradorLista() {
        return new IteradorLista<T>(this, cabecera);
    }
