...
public interface RepositorioConsultaMedica {
    ...
    /**
     * Método para encontrar una Consulta Medica por medio de su Id
     *
     * @param id
     * @return
     * @throws ModeloException
    ...
    /**
     * Método para encontrar todas las consultas médicas asociadas a un
     * historial medico cuyo estado sea pendiente
     *
     * @param idHistorialMedico
     * @return
     * @throws ModeloException
