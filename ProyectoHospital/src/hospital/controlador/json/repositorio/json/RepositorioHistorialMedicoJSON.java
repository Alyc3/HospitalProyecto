...
public class RepositorioHistorialMedicoJSON implements RepositorioHistorialMedico {
    ...
    /**
     * Método para crear un Historial Médico Verifica que no exista uno asociado
     * a la misma persona, en caso de hacerlo retorna una Excepción
     *
     * @param historialMedico
     * @return
     * @throws ModeloException
    ...
    /**
     * Método que permite actualizar la información de un Historial Médico
     * existente Utiliza el id para compararlo con los Historiales Médicos
     * almacenados en el archivo .json Si no encuentra el historial médico
     * solicitado lanzará una excepción
     *
     * @param historialMedico
     * @return
     * @throws ModeloException
    ...
    /**
     * Método que permite buscar un Historial Médico por medio de su id, de no
     * hacerlo retornará null
     *
     * @param id
     * @return
     * @throws ModeloException
    ...
    /**
     * Método que permite encontrar encontrar un Historial Médico asociado a
     * determinada persona, de no encontrarlo retornará null
     *
     * @param idPersona
     * @return
     * @throws ModeloException
    ...
    /**
     * Método que permite encontrar varios Historiales Medicos por medio de sus
     * id's De no encontrarlos se lanzará una excepción
     *
     * @param ids
     * @return
     * @throws ModeloException
