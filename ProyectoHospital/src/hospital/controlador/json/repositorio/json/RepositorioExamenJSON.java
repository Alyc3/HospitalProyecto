...
public class RepositorioExamenJSON implements RepositorioExamen {
    ...
    /**
     * Método que permite crear un Examen nuevo, comprobando que no exista uno
     * con el mismo id y Tipo de Examen
     *
     * @param examen
     * @return
     * @throws ModeloException
    ...
    /**
     * Método que permite obtener y eliminar un Examen existente por medio de su
     * id y Tipo de Examen
     *
    ...
    /**
     * Método que permite encontrar todos los Examenes cuyo id de ConsultaMedia
     * coincidan con el buscado
     *
     * @param idConsultaMedica
     * @return
     * @throws ModeloException
